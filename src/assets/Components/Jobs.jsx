...
const Jobs = () => {
  ...
  const generateMockJobs = (count) => {
    ...
    const descriptions = [
      "Join our team to work on exciting projects and build innovative solutions that impact millions of users. You'll collaborate with experienced professionals and contribute to meaningful work.",
      "We're looking for passionate professionals to join our growing team. This role offers a unique opportunity to work with cutting-edge technologies and advance your career.",
      "We're seeking motivated individuals to be part of our innovative team. You'll have the chance to work on challenging projects and develop valuable skills in a supportive environment.",
      "This position provides hands-on experience with the latest tools and technologies. You'll be mentored by experienced professionals and work on projects that make a real impact.",
      "Excellent opportunity for professionals looking to grow their career. You'll work alongside our talented team and contribute to projects that solve real business challenges.",
    ];
    ...
    return Array(count)
      ...
      .map((_, index) => {
        ...
        const deadline = applicationDeadlines[index % applicationDeadlines.length];
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    // Filter by salary (simplistic approach)
    if (filters.salary.length > 0) {
      let salaryMatch = false;
      for (const salaryRange of filters.salary) {
        if (job.salary.includes(salaryRange)) {
          salaryMatch = true;
          break;
        }
      }
    ...
    if (filters.category.length > 0) {
      ...
      for (const category of filters.category) {
        if (job.title.toLowerCase().includes(category.toLowerCase())) {
          categoryMatch = true;
          break;
        }
      }
    ...
    if (filters.posted) {
      ...
      if (job.postedDaysAgo > days) {
        return false;
      }
    }

    // View by bookmarked
    if (activeView === "bookmarked" && !bookmarked.includes(job.id)) {
      return false;
    }
  ...
  const handleLoadMore = () => {
    ...
    setTimeout(() => {
      setJobs([...jobs, ...generateMockJobs(8)]);
  ...
  // Get job color based on ID for consistency
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:ml-10 md:flex md:space-x-8">
                ...
                <Link
                  to="/jobs"
                  className="text-indigo-600 border-b-2 border-indigo-600 px-3 py-2 text-sm font-medium transition-colors duration-300"
                >
                  Jobs
                </Link>
                <Link
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link
                to="/jobs"
                className="block px-3 py-2 text-base font-medium text-indigo-600 bg-indigo-50 rounded-md transition-colors duration-300"
              >
                Jobs
              </Link>
              <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-base md:text-lg text-indigo-100 mb-8">
              Discover opportunities to grow, advance, and build your career with
              leading companies
            </p>
            ...
            {sortedJobs.map((job) => {
              ...
              return (
                <div
                  ...
                  style={{ borderLeft: `4px solid ${jobColor}` }}
                >
                  {/* Basic Information */}
                  <div className="p-6">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                      ...
                      <div className="flex flex-col items-end space-y-3">
                        ...
                        <div className="flex flex-col items-end text-sm">
                          ...
                          <div className="text-gray-500">
                            Apply by {job.applicationDeadline} days
                          </div>
                        </div>
                  ...
                  {isExpanded && (
                    <div
                      ...
                      style={{
                        backgroundColor: getLighterColor(jobColor, 0.05),
                      }}
                    >
                      <div className="mb-6">
                      ...
                      <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                        <div className="flex gap-4">
                          <span className="text-gray-600">
                            <strong>{job.openPositions}</strong> open
                            positions
                          </span>
                          <span className="text-gray-600">
                            <strong>{job.appliedCount}</strong>{" "}
                            applicants
                          </span>
                        </div>
      ...
      <section className="bg-gray-50 py-12 mt-8">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md divide-y divide-gray-200">
            <div className="p-6">
              ...
              <p className="text-gray-700">
                Click on the "Apply Now" button for the job you're
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
                Tailor your resume to highlight relevant skills and experience for each job.
                Write a compelling cover letter that addresses why you're interested in the specific role
                and company. Ensure your profile is complete with all necessary information and
                showcase projects or accomplishments that demonstrate your abilities.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
                Yes, you can apply for as many jobs as you'd like.
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
                Research the company thoroughly, practice common interview questions,
                prepare examples of your past achievements, and be ready to discuss how
                your skills align with the job requirements. Dress professionally and
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-4">
              Still have questions about jobs?
            </p>
            <Link
              to="/career-resources"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700 mb-4">
                Discover strategies to excel in remote positions, build connections with your team,
                and maintain productivity while working from anywhere.
              </p>
              <Link
                to="/resources/remote-work"
                className="text-indigo-600 hover:text-indigo-800 font-medium flex items-center"
              >
                <span>Read Guide</span>
                <FaExternalLinkAlt className="ml-1 h-3 w-3" />
